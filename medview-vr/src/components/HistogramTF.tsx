...
import type { TransferFunction } from '@/rendering/transferFunction';
import { evaluateColor, normalizeTransferFunction } from '@/rendering/transferFunction';
import type { HistogramData } from '@/volume/types';
